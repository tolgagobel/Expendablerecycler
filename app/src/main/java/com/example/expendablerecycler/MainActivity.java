...
public class MainActivity extends AppCompatActivity {
    ...
    Button modelbutton,markabutton;
...
//            empty_view.setVisibility(View.VISIBLE);
    ...
    private void addModel() {
        ...
        modelbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this,ModelEkle.class);
    ...
    private void addTradeMark() {
        ...
        markabutton=findViewById(R.id.marka_button);
        markabutton.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View v) {

                Intent intent = new Intent(MainActivity.this,MarkaEkle.class);
                startActivity(intent);
            }
        });
